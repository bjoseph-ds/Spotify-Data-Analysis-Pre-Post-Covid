...
- small note: duration isn't properly labeled, since it's normalized, it is not in ms or sec, the decimal is moved over a few so .43 should be 430 seconds
...
comparison_df <- data.frame(
  variable = c("Danceability", "Tempo", "Energy", "Loudness", "Valence", "Duration (normalized)", "Acousticness", "Speechiness"),
...
# Function to display ANOVA results
...
display_anova_results(anova_danceability, "Univariate ANOVA Results for Danceability")
...
# Function to display MANOVA results in a tidy format
display_manova_results <- function(manova_model, caption) {
  # Convert MANOVA summary to a tidy data frame
  tidy_results <- broom::tidy(manova_model, test = "Pillai")
...
display_manova_results(manova_model, "MANOVA Results for Danceability and Tempo")
